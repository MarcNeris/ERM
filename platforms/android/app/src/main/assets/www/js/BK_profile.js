    ...
    if(user.emailVerified){
        ...
        $('.displayEmail').on('click',function(){
            ...
            navigator.notification.alert(
                'Acesse seu email e ative seu cadastro.',
                null,
                'overt | HCM',
                'Fechar'
            );
    ...
    activeCompany = function(NumCgc){
        ...
        employerContractRef.get().then(function(contract) {
            ...
            if(contract){
                ...
                //const refEmployees = FB.ref('employees/'+localStorage.CPF+'/'+localStorage.CNPJ+'/usu');
                        ...
                        if(employees.DevUid){
                            ...
                            if(employees.DevUid!=device.uuid){
                                ...
                                refEmployees.set({
                                    ...
                                    NumCpf: localStorage.CPF,
                                    UsuUid: localStorage.uid,
                                    DevUid: employees.DevUid,
                                    DevNew: device.uuid
