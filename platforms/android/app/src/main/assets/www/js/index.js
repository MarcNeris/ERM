var app = {
    ...
    registraPonto : function(position){
            ...
            if(localStorage.isTouched=='W'){
                ...
                if(position.cached===false){
                    ...
                    if(position.accuracy){
                        ...
                        if(position.provider==='network'){

                            //if(position.accuracy<=(rTry+25)){
        ...
        return localStorage.nTry=(parseInt(localStorage.nTry)+1);
    ...
    writeCapturaPonto : function(position) {
        ...
        usersContractsRef.get().then(function(doc) {
            ...
            var pontoCapturado = {
                ...
                justificativaAprovadorDataHora: 0,
                justificativaDataHora:0,
                latitude: latitude,
                longitude: longitude,
                network: networkInfo,
                networkLog : JSON.parse(localStorage.networkLog),
                device: deviceInfo,
                sitDevice: sitDevice,
                CPF: CPF,
                CNPJ: CNPJ,
            ...
            var FSref = 'users/REP/'+currentUser.uid+'/'+userContract.NumCgc+'/'+YYYYMMDD;
...
loadGmap = function(){
    ...
    if(map&&marker){
        ...
        return initPosition(map, marker);
...
//
/////////////////////////////////////////
initPosition = function(map, marker){
        ...
        try{
            ...
            switch(jsonObject.provider){
                ...
                case 'gps':
                    ...
                    return app.registraPonto(jsonObject);
                ...
                case 'network':
                    ...
                    $('#btnDistance').html(numeral(jsonObject.accuracy+10).format('0,00')+'m');
                    $('#btnDistance').removeClass('hide btn-success btn-danger');
                    $('#btnDistance').addClass('btn-info');
