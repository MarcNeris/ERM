                                    ...
                                    '<div class="col-lg-12">'+
                                        ...
                                        '<div class="text-center">'+
                                            ...
                                            '<div id="btnAprovar${CodEmp}${CodFil}${NumSol}${SeqSol}" class="col-md-6">'+
                                                '<button onclick="aprovarSolicitacaoCompra(\'${ChvInt}\',\'${SeqInt}\',\'${CodEmp}\',\'${CodFil}\',\'${NumSol}\',\'${SeqSol}\')" class="btn btn-fill btn-success btnRigth">Aprovar</button>'+
                                            '</div>'+
                                        '</div>'+
                                    '</div>'+
                                '</div>'+
...
function aprovarSolicitacaoCompra(ChvInt, SeqInt, CodEmp, CodFil, NumSol, SeqSol){
    ...
    window.devicesettings.getAutoTimeZoneMode(function(isAutoTimeZoneMode){
        ...
        if(isAutoTimeZoneMode==0){
            ...
            return  FB.ref('solapr/CodEmp-'+CodEmp+'/CodFil-'+CodFil+'/NumSol-'+NumSol+'/SeqSol-'+SeqSol).set({
                ChvInt : ChvInt,
                SeqInt : SeqInt,
                CodEmp : CodEmp,
                CodFil : CodFil,
                ...
                DatApr : moment().format('YYYY-MM-DD'),
                HorApr : parseFloat(moment().format(' HH.mm'))*60+''
            });
        }
    }, null);
